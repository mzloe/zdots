...
-- Theme and wallpaper ----------------------------------------------------
hl.bind(mainMod .. " + SHIFT + T", hl.dsp.exec_cmd("~/.local/bin/ze theme pick"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("~/.local/bin/ze bg pick"))
hl.bind(secondMod .. " + W", hl.dsp.exec_cmd("~/.local/bin/ze bg next"))
